...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring("Adjective", "Enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring("Liquid", "Enter a type of liquid")
    # Get the player to enter a body part
    bodypart = simpledialog.askstring("Body Part", "Enter a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring("Verb", "Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring("Place", "Enter a place")
